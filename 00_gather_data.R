...
str(uncorr_df)
corr_df <- read.csv("~/netshare/M/VETSA DATA FILES_852014/PracticeEffects/data/output_data/V1V2V3V4_cog_data_pe-adjusted_2025-05-14.csv")
str(corr_df)
...
# Write out the data
write.csv(uncorr_df, "~/netshare/M/Projects/PracEffects_GEE/data/raw_data/V1V2V3V4_cog_data_raw_2025-05-14.csv", row.names = FALSE)
write.csv(corr_df, "~/netshare/M/Projects/PracEffects_GEE/data/raw_data/V1V2V3V4_cog_data_pe-adjusted_2025-05-14.csv", row.names = FALSE)
