...
V3data$rMCI_cons <- with(V3data, (0*(impMEM_cons==0 & impNONMEM_cons==0) +
...
V3data$rMCI_p5 <- with(V3data, (0*(impMEM_comp5==0 & impNONMEM_comp5==0) +
...
V3data$rMCI_p25 <- with(V3data, (0*(impMEM_comp25==0 & impNONMEM_comp25==0) +
