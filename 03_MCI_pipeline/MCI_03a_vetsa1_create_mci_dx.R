...
V1data$rMCI_cons <- with(V1data, (0*(impMEM_cons==0 & impNONMEM_cons==0) +
...
V1data$rMCI_p5 <- with(V1data, (0*(impMEM_comp5==0 & impNONMEM_comp5==0) +
...
V1data$rMCI_p25 <- with(V1data, (0*(impMEM_comp25==0 & impNONMEM_comp25==0) +
