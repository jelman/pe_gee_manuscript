...
# Read in normed data
V2 <- read_csv(pre_imputation_file)
...
write.csv(V2_final, post_imputation_file, row.names=FALSE)
cat("VETSA2 MCI diagnosis creation complete. Files written to:", post_imputation_file, "\n")
summary(V2_final)